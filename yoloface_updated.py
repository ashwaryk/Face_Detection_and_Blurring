...
# The main code of the Face detection using the YOLOv4-tiny algorithm
#
# *******************************************************************
...
parser.add_argument('--model-cfg', type=str, default='./yolov4-tiny.cfg',
...
def _main():
    wind_name = 'face detection and blurring'
    ...
    if args.image:
        ...
        #output_file = args.video[:-4].rsplit('/')[-1] + '_yoloface_100.mp4'
    else:
    ...
    while True:
        ...
        faces, frame, confidence_scores = post_process(frame, outs, CONF_THRESHOLD, NMS_THRESHOLD)
